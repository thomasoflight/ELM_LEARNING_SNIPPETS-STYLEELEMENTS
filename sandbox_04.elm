...
view =
    Element.layout stylesheet <|
        ...
        column None
            ...
            [ el Title [] (text "Sandbox 04 - Height/Width, More Formats")
            , el Small [] (text "height and width : `fill`")
            , el GrayFill [ height fill, width fill ] (text "Hello")
            , el Small [] (text "height : 50%, width 50%")
            , el GrayFill [ height (percent 50), width (percent 50) ] (text "Money Penny")
            , el Small [] (text "height and width : 50%")
            , el GrayFill [ height (percent 50), width (percent 50) ] (text "Mousetrap")
            , row PinkFill
                [ spacing 10 ]
            ...
            , row CoralFill
                [ spacing 20 ]
                [ el GrayFill [ height (px 100), width (fillPortion 1) ] (text "box")
                , el GrayFill [ width (fillPortion 2) ] (text "box")
                , el GrayFill [ width (fillPortion 2) ] (text "box")
                ]
            ]
